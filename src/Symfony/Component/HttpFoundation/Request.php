...
class Request
{
    ...
    {
        return \in_array($this->getMethod(), ['GET', 'HEAD', 'OPTIONS', 'TRACE', 'QUERY']);
    }
    ...
    {
        return \in_array($this->getMethod(), ['HEAD', 'GET', 'PUT', 'DELETE', 'TRACE', 'OPTIONS', 'PURGE', 'QUERY']);
    }
    ...
    {
        return \in_array($this->getMethod(), ['GET', 'HEAD', 'QUERY']);
    }
