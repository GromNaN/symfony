 ...
 * @group integration
 */
class MongoDBExtIntegrationTest extends TestCase
{
    private $redis;
    private $connection;
    ...
    {
        if (!getenv('MESSENGER_MONGODB_DSN')) {
            $this->markTestSkipped('The "MESSENGER_MONGODB_DSN" environment variable is required.');
        }

        try {
            $this->redis = new \Redis();
            $this->connection = Connection::fromDsn(getenv('MESSENGER_MONGODB_DSN'), ['sentinel_master' => getenv('MESSENGER_REDIS_SENTINEL_MASTER')], $this->redis);
    ...
    public function testConnectionBelowRedeliverTimeout()
    {
        ...
        $connection = Connection::fromDsn(getenv('MESSENGER_MONGODB_DSN'), ['sentinel_master' => getenv('MESSENGER_REDIS_SENTINEL_MASTER')], $this->redis);
    ...
    {
        $connection = Connection::fromDsn(getenv('MESSENGER_MONGODB_DSN'),
            ['lazy' => true,
