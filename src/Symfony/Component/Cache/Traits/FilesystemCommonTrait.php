...
trait FilesystemCommonTrait
{
    ...
    {
        // Use MD5 or SSH128 to favor speed over security, which is not an issue here
        $hash = str_replace('/', '-', base64_encode(hash(\PHP_VERSION_ID < 80100 ? 'md5' : 'xxh128', static::class.$id, true)));
